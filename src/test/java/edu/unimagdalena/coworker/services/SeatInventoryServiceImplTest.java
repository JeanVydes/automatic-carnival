...
import edu.unimagdalena.coworker.dto.SeatInventoryDTO;
...
class SeatInventoryServiceImplTest {
    ...
    void testCreateSuccess() {
        SeatInventoryDTO.CreateSeatInventoryDTO req = new SeatInventoryDTO.CreateSeatInventoryDTO(Cabin.ECONOMY, 150,
                100, 1L);
    ...
    void testGetNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> seatInventoryService.getById(1L));
    }
    ...
    void testUpdateSuccess() {
        SeatInventoryDTO.UpdateSeatInventoryDTO req = new SeatInventoryDTO.UpdateSeatInventoryDTO(1L, Cabin.BUSINESS,
                120, 80, 1L);
    ...
    void testListSuccess() {
        ...
        var result = seatInventoryService.getAll();
