...
import edu.unimagdalena.coworker.dto.TagDTO;
...
class TagServiceImplTest {
    ...
    void shouldCreateAndReturnResponseDto() {
        var req = new TagDTO.CreateTagDTO("VIP");
    ...
    void shouldUpdateTag() {
        ...
        var updatedReq = new TagDTO.UpdateTagDTO("NewName");
