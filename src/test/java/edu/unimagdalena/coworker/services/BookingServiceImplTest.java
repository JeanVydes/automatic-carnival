...
import edu.unimagdalena.coworker.dto.BookingDTO;
...
class BookingServiceImplTest {
    ...
    void shouldCreateBooking() {
        ...
        var req = new BookingDTO.CreateBookingDTO(20L, 10L);
    ...
    void shouldThrowWhenPassengerNotFoundOnCreate() {
        var req = new BookingDTO.CreateBookingDTO(20L, 99L);
    ...
    void shouldThrowWhenFlightNotFoundOnCreate() {
        var passenger = new Passenger();
        passenger.setId(10L);
        var req = new BookingDTO.CreateBookingDTO(77L, 10L);
    ...
    void shouldUpdateBooking() {
        ...
        var req = new BookingDTO.UpdateBookingDTO(1L, 40L, 30L);
