...
import edu.unimagdalena.coworker.dto.BookingItemDTO;
...
class BookingItemServiceImplTest {
    ...
    void shouldCreateBookingItem() {
        ...
        var req = new BookingItemDTO.CreateBookingItemDTO(10L, 30L, 20L);
        ...
        assertThat(res.seatId()).isEqualTo(30L);
    ...
    void shouldThrowWhenBookingNotFoundOnCreate() {
        var req = new BookingItemDTO.CreateBookingItemDTO(99L, 30L, 20L);
    ...
    void shouldUpdateBookingItem() {
        ...
        var updateDto = new BookingItemDTO.UpdateBookingItemDTO(1L, 30L, 50L, 40L);
        var res = service.update(1L, updateDto);

        assertThat(res.bookingId()).isEqualTo(30L);
        assertThat(res.seatId()).isEqualTo(50L);
