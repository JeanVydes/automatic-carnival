...
import edu.unimagdalena.coworker.dto.AirportDTO;
...
class AirportServiceImplTest {
    ...
    void shouldCreateAndReturnResponse() {
        var req = new AirportDTO.CreateAirportDTO("AirportTest", "AT");
    ...
    void shouldGetExistingAirport() {
        ...
        AirportResponseDTO res = service.getById(5L);
    ...
    void shouldUpdateAirport() {
        ...
        var updateDto = new AirportDTO.UpdateAirportDTO("NewName", "NN");
    ...
    void shouldListAllAirports() {
        ...
        List<AirportResponseDTO> res = service.getAll();
